...
'
'Generic Dyncommand settings
Public Class DyncommandConfig
    Public Property EnableDyncommandHandler As Boolean = True
    Public Property Commands As List(Of DynCommand)
End Class